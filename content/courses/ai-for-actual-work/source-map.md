...
- Lesson 17 diagram, `skill-package-lesson`: immediately after the lesson 17 raster and caption. URL: `https://media.bhekani.com/p/tliuQ36uWfk8kjVvWjlLFDpwHxobdhqKyetmb6Lt/main.webp`. Alt, caption and title: "A reusable skill packages the job, written context, ordered steps, worked examples, checks and source limits so the same task can be run to the same standard later."
...
- Lesson 18 diagram, `mcp-connection-lesson`: immediately after the lesson 18 raster and caption. URL: `https://media.bhekani.com/p/A-MRYg45i0OcgLsVr5beqWXaRnF8lV64MfliWU2S/main.webp`. Alt, caption and title: "A request names the source it needs, passes separate identity, scope and action gates, reaches an approved source, and returns an answer with its source. A refusal is recorded too."
...
- Lesson 21 diagram, `checked-workflow-lesson`: immediately after the lesson 21 raster and caption. URL: `https://media.bhekani.com/p/fGbRNurAV15b45FkcTB3e1E5EmWdOk8AMoVGhTXm/main.webp`. Alt, caption and title: "Written context becomes a draft, which is checked against sources and cited. A person approves it or sends it back with a reason before the decision is recorded and handed over."
